...
namespace TaxCalculatorTests
{
    public class TaxCalculatorTests
    {
        ...
        public void Test_tax_is_zero_given_earnings_are_zero()
        {
            ...
            var taxAmount = taxCalculator.CalculateProgressiveTax(0);
        ...
        {
            var taxCalculator = new Calculator();
            var taxAmount = taxCalculator.CalculateProgressiveTax(50000, true);
            Assert.Equal(0, taxAmount);
        }
        ...
        {
            var taxCalculator = new Calculator();
            var taxAmountWithDecimal = taxCalculator.CalculateProgressiveTax(50000.65M);
            
            var taxAmountWithoutDecimal = taxCalculator.CalculateProgressiveTax(50000); 
        ...
        {
            var taxCalculator = new Calculator();
            var taxAmount = taxCalculator.CalculateProgressiveTax(20000);
        ...
        {
            var taxCalculator = new Calculator();
            var taxAmount = taxCalculator.CalculateProgressiveTax(40000);
        ...
        {
            var taxCalculator = new Calculator();
            var taxAmount = taxCalculator.CalculateProgressiveTax(60000);
        ...
        {
            var taxCalculator = new Calculator();
            var taxAmount = taxCalculator.CalculateProgressiveTax(150000); //chris' salary
